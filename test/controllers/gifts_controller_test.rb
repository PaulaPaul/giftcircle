...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { about: @gift.about, circleMember_id: @gift.circleMember_id, giftcard: @gift.giftcard, image: @gift.image, name: @gift.name, person_id: @gift.person_id }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { about: @gift.about, circleMember_id: @gift.circleMember_id, giftcard: @gift.giftcard, image: @gift.image, name: @gift.name, person_id: @gift.person_id }
    assert_redirected_to gift_path(assigns(:gift))
  end
